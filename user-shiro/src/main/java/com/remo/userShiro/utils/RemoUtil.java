...
import com.remo.userShiro.common.function.CacheSelector;
...
public class RemoUtil {
    ...
    public static UserDto getCurrentUser() {
        ...
        UserService userService = com.remo.userShiro.utils.SpringContextUtil.getBean(UserService.class);
        CacheService cacheService = com.remo.userShiro.utils.SpringContextUtil.getBean(CacheService.class);
    ...
    public static String encryptToken(String token) {
        try {
            com.remo.userShiro.utils.EncryptUtil encryptUtil = new com.remo.userShiro.utils.EncryptUtil(RemoConstant.TOKEN_CACHE_PREFIX);
